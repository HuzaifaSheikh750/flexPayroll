...
const FeatureCard = ({ icon, title, text, backgroundColor }) => {
  return (
    <div className="card-style-four text-center position-relative mt-40 xs-mt-20 shadow-lg p-3 mb-5 bg-white rounded" style={{paddingLeft:"0px", border:"1px solid #eaeaea", padding:"20px", borderRadius:"20px", height:"470px"}}>
