...
const AppBanner2 = () => {
    ...
    return (
        <div className="row align-items-center" style={{ width: "100%" }}>
                        ...
                        <div className="row">
                            <div className="col-lg-10">
                                ...
                                <p style={{ textAlign: "end", marginTop: "20px", width: "100%" }}>
                                    KAISPE's Purchase Requisition App offers an intuitive and user-friendly interface, making it easy for
                    ...
                    <div className="title-style-one" style={{marginTop:"20px"}} >
                        <div className="row">
                            <div className="col-lg-10">
                                ...
                                <p style={{ textAlign: "end", marginTop: "20px", width: "100%" }}>
                                    KAISPE's Purchase Requisition App offers flexible pricing options, making it accessible to organizations
            ...
            <div className="col-lg-4 col-md-12 col-sm-12">
                <img src="images/purchase/image_4.png" alt="" className="lazy-img main-img ms-auto " style={{}} />
            </div>
                    ...
                    <div className="title-style-one"  style={{marginTop:"20px"}}>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-10">
                                ...
                                <p style={{ textAlign: "start", marginTop: "20px", width: "100%" }}>
                                    KAISPE's Purchase Requisition mobile App is available in both tablet and mobile versions, enabling
